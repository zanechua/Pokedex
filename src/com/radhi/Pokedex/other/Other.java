...
public class Other {
    ...
    public static final String ArtURL =
            "https://github.com/Acrophobic/Pokedex-Media/releases/download/2.1/Art.zip";
    public static final String SpritesURL =
            "https://github.com/Acrophobic/Pokedex-Media/releases/download/2.1/Sprites.zip";
